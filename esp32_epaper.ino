...
const char HelloWorld[] = "Terima kasih!";
const char HelloWeACtStudio[] = "barang sudah \nsampai";
const char HelloWeACtStudi[] = "barang bekerja \nbaik!";
...
void helloWorld()
{
  ...
  do
  {
    ...
    display.getTextBounds(HelloWeACtStudi, 0, 0, &tbx, &tby, &tbw, &tbh);
    x = ((display.width() - tbw) / 2) - tbx;
    display.setCursor(x, y + tbh + tbh + 20);
    display.print(HelloWeACtStudi);
...
void helloFullScreenPartialMode2()
{
  // Serial.println("helloFullScreenPartialMode");
